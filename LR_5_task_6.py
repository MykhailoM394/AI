...
# Визначаємо багатошарову нейронну мережу з трьома шарами.
# Перший шар складається з трьох нейронів, другий шар з двох нейронів, вихідний шар складається з одного нейрона.
nn = nl.net.newff([[min_val, max_val]], [3, 2, 1])
