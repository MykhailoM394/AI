...
# Створюємо парсер для обробки вхідних аргументів
...
def euclidean_score(dataset, user1, user2):
    ...
    # Фільми, оцінені обома користувачами
    common_movies = {}
    ...
    # Якщо немає спільних фільмів, повертати 0
...
# Обчислення коефіцієнта кореляції Пірсона для user1 і user2
def pearson_score(dataset, user1, user2):
    ...
    # Обчислимо суму добутків рейтингових оцінок
    sum_of_products = np.sum([dataset[user1][item] * dataset[user2][item] for item in common_movies])

    # Обчислимо різні параметри, необхідні для обчислення оцінки подібності по Пірсону
